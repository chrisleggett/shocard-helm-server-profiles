    ...
    <div class="body-container">
        <div id="" class="ping-body-container">
            ...
            <div class="error-container">
                The resource you requested could not be found. Please return with this link:<div style="text-align: center;"><a href="/SpSample/MainPage">SP Sample Application</a></div>
            </div>
        </div>

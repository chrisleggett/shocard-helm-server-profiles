        ...
        <div class="body-container">
            <div id="" class="ping-body-container">
                <div class="header-block">
                    ...
                    <div id="" class="left-header"><a href="<c:out value="<%= URLUtil.getConfigOptionsUrl(request) %>" />">Configuration</a></div>
                    <div class="right-header">
                                <%  if (userInfo != null) { %>
                                    <a href="<c:out value ="<%= URLUtil.getLocalLogoutUrl(request) %>" />">Local Logout</a>

                                <% } %>
                    </div>
                </div> <!-- header-block -->
                <form name="mainForm" action="<c:out value ="<%= URLUtil.getActionWithParams(request) %>" />" method="POST" >
                        ...
                        <div class="sso-container">
                                        ...
                                        <div class="select-wrapper">
                                            <select class="input-select" name="PartnerIdpId" id="PartnerIdpId" onchange="createSSOLink('<%= errorPageUrl %>');">
                                                ...
                                                for(int i=0;i<connectionList.size();i++){
                                                    ...
                                                    String ssoUrl = URLUtil.getSpStartSSOUrl(connectionId, null, null);
                                                %>
                            ...
                            <div class="ping-input">
                                <label class="ping-input-label">SP Adapter Instances
                                    <div class="ping-input-container">
                                        <div class="select-wrapper">
                                            <select class="input-select" name="SpAdapterId" id="SpAdapterId" onchange="createSSOLink('<%= errorPageUrl %>');">
                                            <%
                                            ...
                                            %>
                                               <option value ="<c:out value ="<%= adapterName %>" />" > <c:out value ="<%= adapterName %>" /> </option>
                                            <%
                                            }
                                            %>
                                            </select>
                            ...
                            <div class="ping-input">
                                <div class="ping-checkbox-container">
                                    <input type="checkbox" id="IsPassive" name="IsPassive" value="true" onchange="createSSOLink('<%= errorPageUrl %>');"/>
                                </div>
                            ...
                            <div class="ping-input">
                                <div class="ping-checkbox-container">
                                    <input type="checkbox" id="ForceAuthn" name="ForceAuthn" value="true" onchange="createSSOLink('<%= errorPageUrl %>');"/>
                                </div>
                        ...
                        <div class="attributes-container">
                            <div class="ping-input">
                                ...
                                <table class="attributes-table">
                                    <c:out value ="<%= DisplayUtil.writeHtmlUserAttributes(userInfo) %>" escapeXml="false" />
                                </table>
                            </div> <!-- ping-input -->
